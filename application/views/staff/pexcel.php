            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="<?= base_url('Staff/Excel_ly') ?>" method="POST">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="<?= base_url('Staff/Excel_class') ?>" method="POST">
                                <div class="input-group mb-3">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="<?= base_url('Staff/Excel_study') ?>" method="POST">
                                <div class="input-group mb-3">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="<?= base_url('Staff/Excel_year') ?>" method="POST">
                                <div class="input-group mb-3">
